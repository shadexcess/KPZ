...
/// <summary>
/// Represents an error that occurs when a dependency cycle is detected in the package dependency graph.
/// </summary>
public class CyclicDependencyException : DependencyException
{
    /// <summary>
