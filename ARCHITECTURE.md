...
## Структури даних
Оскільки матимемо справу з графом, то його буде доцільно представити як асоціативний словник, а конкретно у випадку C# - Dictionary. Тоді ключем буде пакет, а значенням - список пакетів, від яких залежить цей пакет (це буде представлено динамічним масивом - List).
